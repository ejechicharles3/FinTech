...
{
    public partial class AddChangesToApplication : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_ContributionTypes_ContributionTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_ContributionTypeId",
                table: "AspNetUsers",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1,
                columns: new[] { "Date", "Time" },
                values: new object[] { new DateTime(2022, 2, 24, 22, 30, 19, 857, DateTimeKind.Local).AddTicks(5151), new DateTime(2022, 2, 24, 22, 30, 19, 859, DateTimeKind.Local).AddTicks(4136) });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 2,
                columns: new[] { "Date", "Time" },
                values: new object[] { new DateTime(2022, 2, 24, 22, 30, 19, 859, DateTimeKind.Local).AddTicks(5981), new DateTime(2022, 2, 24, 22, 30, 19, 859, DateTimeKind.Local).AddTicks(5991) });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 3,
                columns: new[] { "Date", "Time" },
                values: new object[] { new DateTime(2022, 2, 24, 22, 30, 19, 859, DateTimeKind.Local).AddTicks(5995), new DateTime(2022, 2, 24, 22, 30, 19, 859, DateTimeKind.Local).AddTicks(5996) });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 4,
                columns: new[] { "Date", "Time" },
                values: new object[] { new DateTime(2022, 2, 24, 22, 30, 19, 859, DateTimeKind.Local).AddTicks(5998), new DateTime(2022, 2, 24, 22, 30, 19, 859, DateTimeKind.Local).AddTicks(6000) });
        }
    }
}
